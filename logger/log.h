...
//---------------------------------------------------------------------------------
	...
	//---------------------------------------------------------------------------------
class stderr_log_policy : public log_policy_interface
{
    std::unique_ptr< std::ofstream > out_stream;
public:
    stderr_log_policy() {}
...
void stderr_log_policy::write(const std::string& msg)
{
...
template< typename policy> class Test{
public:
    void doOneThing(policy&  p);
};
template<typename policy> void Test<policy>::doOneThing(policy& p){
